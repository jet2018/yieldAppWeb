...
class Post(models.Model):
    ...
    likes = models.ManyToManyField(
        User, verbose_name='Likes', related_name='Likes', blank=True)
...
class postComment(models.Model):
    ...
    likes = models.ManyToManyField(
        User, verbose_name='Likes', related_name='likecomment', blank=True)
...
class Commentreply(models.Model):
    ...
    reply_by = models.ForeignKey(
        User, related_name='replier', on_delete=models.CASCADE)
    reply_body = models.TextField(max_length=200)
    reply_on = models.DateTimeField(auto_now_add=True)
    likes = models.ManyToManyField(
        User, verbose_name='Likes', related_name='likereply',  blank=True)
